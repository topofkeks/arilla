...
// ============================================================
// File Name: CMP_32_ALU_UNSIGNED.v
// Megafunction Name(s):
// 			LPM_COMPARE
//
...
//lpm_compare DEVICE_FAMILY="Cyclone III" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=32 ageb alb dataa datab
...
module  CMP_32_ALU_UNSIGNED_cmpr
	( 
	ageb,
	alb,
	dataa,
...
`endif
	...
	assign
		alb = wire_alb_int,
		ageb = !wire_alb_int;
endmodule //CMP_32_ALU_UNSIGNED_cmpr
//VALID FILE
...
module CMP_32_ALU_UNSIGNED (
	...
	CMP_32_ALU_UNSIGNED_cmpr	CMP_32_ALU_UNSIGNED_cmpr_component (
				.dataa (dataa),
				.datab (datab),
				.ageb (sub_wire0),
				.alb (sub_wire1));
