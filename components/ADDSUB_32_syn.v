...
//lpm_add_sub DEVICE_FAMILY="Cyclone III" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=32 ONE_INPUT_IS_CONSTANT="NO" add_sub dataa datab result
...
module ADDSUB_32 (
	...
	ADDSUB_32_add_sub	ADDSUB_32_add_sub_component (
				.add_sub (add_sub),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
